...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-local-development-secret-key')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.category_counts',
            ],
        },
    },
]
...
# Backward-compatible fallback for older Django settings conventions.
